...
@app.command()
def describe(data_path: Path = typer.Option(None, help="Path to rice.csv (defaults to data/rice.csv)")) -> None:
...
@app.command()
def train(
    data_path: Path = typer.Option(None, help="Path to rice.csv (defaults to data/rice.csv)"),
...
def forecast(
    data_path: Path = typer.Option(None, help="Path to rice.csv (defaults to data/rice.csv)"),
    output_path: Path = typer.Option(Path("forecast/next_month_forecast.csv")),
    advisories_path: Path = typer.Option(Path("forecast/rule_based_advisories.csv")),
